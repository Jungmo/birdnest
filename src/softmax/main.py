...
trainX = trainX.reshape(-1, 200, 200, 3)  # 28x28x1 input img
testX = testX.reshape(-1, 200, 200, 3)  # 28x28x1 input img
...
w4 = init_weights([2880000, 625]) # FC 128 * 4 * 4 inputs, 625 outputs
...
with tf.Session() as sess:
    ...
    for i in range(1):
        ...
        test_indices = test_indices[0:test.numOfFile]
